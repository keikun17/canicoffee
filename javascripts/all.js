...
(function() {
  ...
  tick = function() {
    var _woke, end_first_coffee_cycle, end_second_coffee_cycle, now, start_first_coffee_cycle, start_second_coffee_cycle, woke_up_at;
    now = new moment();
    ...
    if (woke_up_at.format() !== 'Invalid date') {
      ...
      return document.getElementById('second_coffee_cycle').innerHTML = (start_second_coffee_cycle.format('hh:mm a')) + " to " + (end_second_coffee_cycle.format('hh:mm a'));
    } else {
      return document.getElementById('recommendations').style.visibility = 'hidden';
    }
  };
